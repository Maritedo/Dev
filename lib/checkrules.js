 ...
 * @param {*} rules_ 
 * @param {string} val_ 
 * @returns 验证通过时返回null，若不满足条件则返回错误列表
 */
var ind = 0;
/**
 * 
    ...
    "idcode": [
        ...
        },
        {
            func: (e) => {
                ...
                return day > [31, isLunar(year) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][month - 1]
            },
            msg: "无效的日期"
        }
    ],
